...
class LegacyBase64TestCase(unittest.TestCase):
    ...
    def test_encodebytes(self):
        ...
        eq(
            base64.encodebytes(b"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#0^&*();:<>,. []{}"),
...
class BaseXYTestCase(unittest.TestCase):
    ...
    def test_b64encode(self):
        ...
        eq(
            base64.b64encode(b"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#0^&*();:<>,. []{}"),
            b"YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXpBQkNE"
    ...
    def test_a85encode(self):
        ...
        eq(base64.a85encode(b"\0\0\0\0www.python.org", wrapcol=7, adobe=False), b"zGB\\6`E\n-ZP=Df.\n1GEb>")
    ...
    def test_z85encode(self):
        ...
        self.check_other_types(base64.z85encode, b"www.python.org", b"CxXl-AcVLsz/dgCA+t")
    ...
    def test_z85decode(self):
        ...
        self.check_other_types(base64.z85decode, b"CxXl-AcVLsz/dgCA+t", b"www.python.org")

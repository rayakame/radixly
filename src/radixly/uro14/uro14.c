...
const char radixly_uro14_encode_doc[] =
    PyDoc_STR("uro14_encode($module, data, /)\n"
              ...
              "-------\n"
              "str\n"
              "    The encoded text; even empty input yields the one-character\n"
              "    prefix.\n"
              "\n"
              "Raises\n"
              "------\n"
              ...
              ">>> len(uro14.encode(b'hello'))\n"
              "4\n"
              ">>> uro14.decode(uro14.encode(b'hello'))\n"
              "b'hello'");
PyObject *
...
const char radixly_uro14_decode_doc[] =
    PyDoc_STR("uro14_decode($module, data, /)\n"
              ...
              "----------\n"
              "data\n"
              "    The text to decode, prefix included.\n"
              "\n"
              "Returns\n"
              "-------\n"
              "bytes\n"
              "    The decoded payload. The one-character prefix-only string decodes to\n"
              "    ``b''``; the empty string has no prefix and is rejected.\n"
              "\n"
              "Raises\n"
              "------\n"
              "TypeError\n"
              ...
              "DecodeError\n"
              "    On an invalid character, a length claim the body cannot satisfy,\n"
              "    or bad padding; ``position`` is the index of the offending\n"
              "    character (0 for a prefix that contradicts the body).\n"
              "\n"
              "Examples\n"
              "--------\n"
              ">>> import radixly\n"
              ">>> try:\n"
              "...     radixly.uro14.decode('!')\n"

...
const char radixly_base32768_encode_doc[] =
    PyDoc_STR("base32768_encode($module, data, /)\n"
              ...
              "\n"
              "Every character carries 15 payload bits. A leftover of 7 bits or\n"
              "fewer ends in a short character from a second alphabet of 128; a\n"
              "bigger leftover ends in a padded 15-bit character. ``n`` input bytes\n"
              "become ``ceil(8 * n / 15)`` BMP code points from qntm's alphabets.\n"
              "\n"
              "Parameters\n"
              "----------\n"
              "data\n"
